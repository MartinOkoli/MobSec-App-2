...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\kotlinx\coroutines\intrinsics\CancellableKt.smali */
public final class CancellableKt {
    public static final <T> void startCoroutineCancellable(Function1<? super Continuation<? super T>, ? extends Object> startCoroutineCancellable, Continuation<? super T> completion) {
        ...
        try {
            ...
            completion.resumeWith(Result.m14constructorimpl(ResultKt.createFailure(e$iv)));
        }
    }
    ...
    private static final void runSafely(Continuation<?> continuation, Function0<Unit> function0) {
        try {
            ...
            Result.Companion companion = Result.INSTANCE;
            continuation.resumeWith(Result.m14constructorimpl(ResultKt.createFailure(e)));
        }
    }
}
