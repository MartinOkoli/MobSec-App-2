...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\com\google\firebase\FirebaseCommonRegistrar.smali */
public class FirebaseCommonRegistrar implements ComponentRegistrar {
    ...
    public List<Component<?>> getComponents() {
        ...
        result.add(LibraryVersionComponent.fromContext(TARGET_SDK, FirebaseCommonRegistrar$$Lambda$1.instance));
        result.add(LibraryVersionComponent.fromContext(MIN_SDK, FirebaseCommonRegistrar$$Lambda$4.instance));
        result.add(LibraryVersionComponent.fromContext(ANDROID_PLATFORM, FirebaseCommonRegistrar$$Lambda$5.instance));
