...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\com\google\android\material\appbar\AppBarLayout.smali */
public class AppBarLayout extends LinearLayout implements CoordinatorLayout.AttachedBehavior {
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\com\google\android\material\appbar\AppBarLayout$BaseOnOffsetChangedListener.smali */
    public interface BaseOnOffsetChangedListener<T extends AppBarLayout> {
        void onOffsetChanged(T t, int i);
    }

    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\com\google\android\material\appbar\AppBarLayout$OnOffsetChangedListener.smali */
    ...
    public AppBarLayout(Context context, AttributeSet attrs, int defStyleAttr) throws Resources.NotFoundException, SecurityException {
        int i = DEF_STYLE_RES;
    ...
    public void setStatusBarForeground(Drawable drawable) throws SecurityException {
    ...
    public void setStatusBarForegroundColor(int color) throws SecurityException {
        setStatusBarForeground(new ColorDrawable(color));
    }

    public void setStatusBarForegroundResource(int resId) throws SecurityException {
    ...
    boolean setLiftedState(boolean lifted) throws Resources.NotFoundException {
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\com\google\android\material\appbar\AppBarLayout$LayoutParams.smali */
    public static class LayoutParams extends LinearLayout.LayoutParams {
        ...
        /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\com\google\android\material\appbar\AppBarLayout$LayoutParams$ScrollFlags.smali */
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\com\google\android\material\appbar\AppBarLayout$Behavior.smali */
    public static class Behavior extends BaseBehavior<AppBarLayout> {

        /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\com\google\android\material\appbar\AppBarLayout$Behavior$DragCallback.smali */
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\com\google\android\material\appbar\AppBarLayout$BaseBehavior.smali */
    protected static class BaseBehavior<T extends AppBarLayout> extends HeaderBehavior<T> {
        ...
        /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\com\google\android\material\appbar\AppBarLayout$BaseBehavior$BaseDragCallback.smali */
        ...
        @Override // androidx.coordinatorlayout.widget.CoordinatorLayout.Behavior
        public void onNestedPreScroll(CoordinatorLayout coordinatorLayout, T child, View target, int dx, int dy, int[] consumed, int type) throws Resources.NotFoundException {
            int min;
            int max;
            if (dy != 0) {
                if (dy < 0) {
        ...
        @Override // androidx.coordinatorlayout.widget.CoordinatorLayout.Behavior
        public void onStopNestedScroll(CoordinatorLayout coordinatorLayout, T abl, View target, int type) throws Resources.NotFoundException {
        ...
        public boolean onLayoutChild(CoordinatorLayout parent, T abl, int layoutDirection) throws Resources.NotFoundException {
            int offset;
                ...
                if (scrollingView.canScrollVertically(-1)) {
                    ...
                    if (dy != 0) {
                        ViewCompat.replaceAccessibilityAction(coordinatorLayout, AccessibilityNodeInfoCompat.AccessibilityActionCompat.ACTION_SCROLL_BACKWARD, null, new AccessibilityViewCommand() { // from class: com.google.android.material.appbar.AppBarLayout.BaseBehavior.2
                            ...
                            public boolean perform(View view, AccessibilityViewCommand.CommandArguments arguments) throws Resources.NotFoundException {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        @Override // com.google.android.material.appbar.HeaderBehavior
        public void onFlingFinished(CoordinatorLayout parent, T layout) throws Resources.NotFoundException {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        @Override // com.google.android.material.appbar.HeaderBehavior
        public int setHeaderTopBottomOffset(CoordinatorLayout coordinatorLayout, T appBarLayout, int newOffset, int minOffset, int maxOffset) throws Resources.NotFoundException {
        ...
        private void updateAppBarLayoutDrawableState(CoordinatorLayout parent, T layout, int offset, int direction, boolean forceJump) throws Resources.NotFoundException {
        ...
        /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\com\google\android\material\appbar\AppBarLayout$BaseBehavior$SavedState.smali */
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\com\google\android\material\appbar\AppBarLayout$ScrollingViewBehavior.smali */
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        private void updateLiftedStateIfNeeded(View child, View dependency) throws Resources.NotFoundException {
            if (dependency instanceof AppBarLayout) {
