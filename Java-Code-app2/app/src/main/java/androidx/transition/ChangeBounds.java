...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\androidx\transition\ChangeBounds.smali */
public class ChangeBounds extends Transition {
    ...
    private static final Property<View, PointF> POSITION_PROPERTY = new Property<View, PointF>(PointF.class, "position") { // from class: androidx.transition.ChangeBounds.6
        @Override // android.util.Property
        public void set(View view, PointF topLeft) throws SecurityException, IllegalArgumentException {
    ...
    static {
        ...
        TOP_LEFT_PROPERTY = new Property<ViewBounds, PointF>(PointF.class, str) { // from class: androidx.transition.ChangeBounds.2
            @Override // android.util.Property
            public void set(ViewBounds viewBounds, PointF topLeft) throws SecurityException, IllegalArgumentException {
        ...
        BOTTOM_RIGHT_PROPERTY = new Property<ViewBounds, PointF>(PointF.class, str2) { // from class: androidx.transition.ChangeBounds.3
            @Override // android.util.Property
            public void set(ViewBounds viewBounds, PointF bottomRight) throws SecurityException, IllegalArgumentException {
        ...
        BOTTOM_RIGHT_ONLY_PROPERTY = new Property<View, PointF>(PointF.class, str2) { // from class: androidx.transition.ChangeBounds.4
            @Override // android.util.Property
            public void set(View view, PointF bottomRight) throws SecurityException, IllegalArgumentException {
    ...
    @Override // androidx.transition.Transition
    public Animator createAnimator(final ViewGroup sceneRoot, TransitionValues startValues, TransitionValues endValues) throws SecurityException, IllegalArgumentException {
        final View view;
        int startLeft;
        int startTop;
        int endLeft;
                    ...
                    if (numChanges > 0) {
                        ...
                        if (view.getParent() instanceof ViewGroup) {
                            ...
                            Transition.TransitionListener transitionListener = new TransitionListenerAdapter() { // from class: androidx.transition.ChangeBounds.9
                                ...
                                public void onTransitionCancel(Transition transition) throws SecurityException, IllegalArgumentException {
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\androidx\transition\ChangeBounds$ViewBounds.smali */
    private static class ViewBounds {
        ...
        void setTopLeft(PointF topLeft) throws SecurityException, IllegalArgumentException {
        ...
        void setBottomRight(PointF bottomRight) throws SecurityException, IllegalArgumentException {
