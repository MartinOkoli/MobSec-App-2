...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\okhttp3\internal\connection\RealConnection.smali */
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\okhttp3\internal\connection\RealConnection$WhenMappings.smali */
    ...
    /* JADX WARN: Removed duplicated region for block: B:77:0x0181 A[EDGE_INSN: B:77:0x0181->B:63:0x0181 BREAK  A[LOOP:0: B:69:0x00aa->B:79:?], SYNTHETIC] */
    /*
    ...
    */
    ...
    private final void connectTls(ConnectionSpecSelector connectionSpecSelector) throws Throwable {
        ...
        try {
            ...
            socketCreateSocket = sslSocketFactory.createSocket(this.rawSocket, address.url().host(), address.url().port(), true);
        } catch (Throwable th) {
            th = th;
        }
        try {
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\okhttp3\internal\connection\RealConnection$Companion.smali */
