...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\kotlinx\coroutines\CoroutineScopeKt.smali */
public final class CoroutineScopeKt {
    ...
    public static final CoroutineScope CoroutineScope(CoroutineContext context) {
        Intrinsics.checkParameterIsNotNull(context, "context");
        return new ContextScope(context.get(Job.INSTANCE) != null ? context : context.plus(JobKt__JobKt.Job$default((Job) null, 1, (Object) null)));
    }
