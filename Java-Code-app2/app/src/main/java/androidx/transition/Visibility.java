...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\androidx\transition\Visibility.smali */
public abstract class Visibility extends Transition {
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\androidx\transition\Visibility$Mode.smali */
    public @interface Mode {
    }

    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\androidx\transition\Visibility$VisibilityInfo.smali */
    ...
    public Animator onDisappear(final ViewGroup sceneRoot, TransitionValues startValues, int startVisibility, TransitionValues endValues, int endVisibility) throws IllegalArgumentException {
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\androidx\transition\Visibility$DisappearListener.smali */
    private static class DisappearListener extends AnimatorListenerAdapter implements Transition.TransitionListener, AnimatorUtils.AnimatorPauseListenerCompat {
        ...
        DisappearListener(View view, int finalVisibility, boolean suppressLayout) throws SecurityException, IllegalArgumentException {
            this.mView = view;
        ...
        public void onAnimationPause(Animator animation) throws IllegalArgumentException {
            if (!this.mCanceled) {
        ...
        @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorPauseListener, androidx.transition.AnimatorUtils.AnimatorPauseListenerCompat
        public void onAnimationResume(Animator animation) throws IllegalArgumentException {
            if (!this.mCanceled) {
        ...
        @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
        public void onAnimationEnd(Animator animation) throws SecurityException, IllegalArgumentException {
        ...
        @Override // androidx.transition.Transition.TransitionListener
        public void onTransitionEnd(Transition transition) throws SecurityException, IllegalArgumentException {
            hideViewWhenNotCanceled();
            transition.removeListener(this);
        }
        ...
        @Override // androidx.transition.Transition.TransitionListener
        public void onTransitionPause(Transition transition) throws SecurityException, IllegalArgumentException {
            suppressLayout(false);
        }

        @Override // androidx.transition.Transition.TransitionListener
        public void onTransitionResume(Transition transition) throws SecurityException, IllegalArgumentException {
            suppressLayout(true);
        }

        private void hideViewWhenNotCanceled() throws SecurityException, IllegalArgumentException {
            if (!this.mCanceled) {
                ViewUtils.setTransitionVisibility(this.mView, this.mFinalVisibility);
        ...
        private void suppressLayout(boolean suppress) throws SecurityException, IllegalArgumentException {
            ViewGroup viewGroup;
