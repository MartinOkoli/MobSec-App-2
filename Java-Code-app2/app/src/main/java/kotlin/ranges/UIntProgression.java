...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\kotlin\ranges\UIntProgression.smali */
public class UIntProgression implements Iterable<UInt>, KMappedMarker {
    ...
    private UIntProgression(int start, int endInclusive, int step) {
        ...
        this.first = start;
        this.last = UProgressionUtilKt.m1181getProgressionLastElementNkh28Cs(start, endInclusive, step);
        this.step = step;
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append(UInt.m137toStringimpl(this.first));
            sb.append("..");
            sb.append(UInt.m137toStringimpl(this.last));
            sb.append(" step ");
            i = this.step;
        } else {
            sb = new StringBuilder();
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\kotlin\ranges\UIntProgression$Companion.smali */
    public static final class Companion {
        ...
        public final UIntProgression m1197fromClosedRangeNkh28Cs(int rangeStart, int rangeEnd, int step) {
