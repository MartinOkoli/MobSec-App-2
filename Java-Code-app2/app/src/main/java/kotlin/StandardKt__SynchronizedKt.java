...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\kotlin\StandardKt__SynchronizedKt.smali */
class StandardKt__SynchronizedKt extends StandardKt__StandardKt {
    /* renamed from: synchronized, reason: not valid java name */
    private static final <R> R m24synchronized(Object lock, Function0<? extends R> function0) {
        R rInvoke;
        synchronized (lock) {
            try {
