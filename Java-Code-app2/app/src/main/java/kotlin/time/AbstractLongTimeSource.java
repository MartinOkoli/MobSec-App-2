...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\kotlin\time\AbstractLongTimeSource.smali */
public abstract class AbstractLongTimeSource implements TimeSource {
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\kotlin\time\AbstractLongTimeSource$LongTimeMark.smali */
    private static final class LongTimeMark extends TimeMark {
        ...
        public TimeMark mo1266plusLRDsOJo(double duration) {
            return new LongTimeMark(this.startedAt, this.timeSource, Duration.m1296plusLRDsOJo(this.offset, duration), null);
        }
    }

    @Override // kotlin.time.TimeSource
    public TimeMark markNow() {
        return new LongTimeMark(read(), this, Duration.INSTANCE.m1317getZEROUwyO8pc(), null);
    }
}
