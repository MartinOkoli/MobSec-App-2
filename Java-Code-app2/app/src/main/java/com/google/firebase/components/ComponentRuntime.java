...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\com\google\firebase\components\ComponentRuntime.smali */
public class ComponentRuntime extends AbstractComponentContainer implements ComponentLoader {
            ...
            if (component.isValue()) {
                ...
                for (Class<?> anInterface : component.getProvidedInterfaces()) {
                    if (!this.lazyInstanceMap.containsKey(anInterface)) {
                        ...
                        OptionalProvider<Object> deferred = (OptionalProvider) existingProvider;
                        runnables.add(ComponentRuntime$$Lambda$3.lambdaFactory$(deferred, provider));
                    }
                }
            }
        }
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\com\google\firebase\components\ComponentRuntime$Builder.smali */
