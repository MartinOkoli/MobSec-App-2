...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\kotlinx\coroutines\flow\FlowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$5.smali */
public final class FlowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$5<R> implements Flow<R> {
    ...
    public Object collect(FlowCollector collector, Continuation $completion) {
        ...
        return $this$collect$iv.collect(new lambda.1(collector, this), $completion);
    }
    ...
    public Object collect$$forInline(FlowCollector collector, Continuation continuation) {
        ...
        InlineMarker.mark(5);
        Flow $this$collect$iv = this.$this_unsafeTransform$inlined;
        FlowCollector flowCollector = new lambda.1(collector, this);
        InlineMarker.mark(0);
        $this$collect$iv.collect(flowCollector, continuation);
        InlineMarker.mark(2);
        InlineMarker.mark(1);
