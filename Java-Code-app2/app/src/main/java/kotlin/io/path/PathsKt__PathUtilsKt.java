...
class PathsKt__PathUtilsKt extends PathsKt__PathReadWriteKt {
    ...
    public static final String getInvariantSeparatorsPath(Path invariantSeparatorsPath) {
        ...
        return PathsKt.getInvariantSeparatorsPathString(invariantSeparatorsPath);
    }
    ...
    private static final Object getAttribute(Path $this$getAttribute, String attribute, LinkOption... options) {
    ...
    private static final UserPrincipal getOwner(Path $this$getOwner, LinkOption... options) {
