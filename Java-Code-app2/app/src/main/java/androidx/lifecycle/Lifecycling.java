...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\androidx\lifecycle\Lifecycling.smali */
public class Lifecycling {
    ...
    @Deprecated
    static GenericLifecycleObserver getCallback(Object object) throws SecurityException {
    ...
    static LifecycleEventObserver lifecycleEventObserver(Object object) throws SecurityException {
    ...
    private static Constructor<? extends GeneratedAdapter> generatedConstructor(Class<?> klass) throws SecurityException {
        String str;
        try {
    ...
    private static int getObserverConstructorType(Class<?> klass) throws SecurityException {
    ...
    private static int resolveObserverCallbackType(Class<?> klass) throws SecurityException {
