...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\androidx\core\graphics\drawable\DrawableCompat.smali */
public final class DrawableCompat {
    ...
    public static boolean setLayoutDirection(Drawable drawable, int layoutDirection) throws SecurityException {
        if (Build.VERSION.SDK_INT >= 23) {
    ...
    public static int getLayoutDirection(Drawable drawable) throws SecurityException {
        if (Build.VERSION.SDK_INT >= 23) {
