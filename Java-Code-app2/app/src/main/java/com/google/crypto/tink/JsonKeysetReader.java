...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\com\google\crypto\tink\JsonKeysetReader.smali */
public final class JsonKeysetReader implements KeysetReader {
    ...
    private EncryptedKeyset encryptedKeysetFromJson(JSONObject json) throws JSONException {
        ...
        return EncryptedKeyset.newBuilder().setEncryptedKeyset(ByteString.copyFrom(encryptedKeyset)).setKeysetInfo(keysetInfoFromJson(json.getJSONObject("keysetInfo"))).build();
    }
    ...
    private KeyData keyDataFromJson(JSONObject json) throws JSONException {
        ...
        return KeyData.newBuilder().setTypeUrl(json.getString("typeUrl")).setValue(ByteString.copyFrom(value)).setKeyMaterialType(getKeyMaterialType(json.getString("keyMaterialType"))).build();
    }
