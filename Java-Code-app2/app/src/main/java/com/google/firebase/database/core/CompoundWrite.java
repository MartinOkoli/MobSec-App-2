...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\com\google\firebase\database\core\CompoundWrite.smali */
public final class CompoundWrite implements Iterable<Map.Entry<Path, Node>> {
    ...
    public CompoundWrite addWrites(Path path, CompoundWrite updates) {
        return (CompoundWrite) updates.writeTree.fold(this, new 1(this, path));
    }
