...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\kotlin\time\DurationKt.smali */
public final class DurationKt {
    ...
    public static final double toDuration(double $this$toDuration, TimeUnit unit) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        return Duration.m1272constructorimpl(DurationUnitKt.convertDurationUnit($this$toDuration, unit, TimeUnit.NANOSECONDS));
    }
    ...
    private static final double m1319timesmvk6XK0(int $this$times, double duration) {
        return Duration.m1299timesUwyO8pc(duration, $this$times);
    }

    /* renamed from: times-kIfJnKk, reason: not valid java name */
    private static final double m1318timeskIfJnKk(double $this$times, double duration) {
        return Duration.m1298timesUwyO8pc(duration, $this$times);
    }
}
