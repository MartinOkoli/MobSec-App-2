...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\okhttp3\internal\connection\ExchangeFinder.smali */
public final class ExchangeFinder {
    ...
    public final ExchangeCodec find(OkHttpClient client, RealInterceptorChain chain) {
        ...
        try {
            RealConnection resultConnection = findHealthyConnection(chain.getConnectTimeoutMillis$okhttp(), chain.getReadTimeoutMillis(), chain.getWriteTimeoutMillis(), client.pingIntervalMillis(), client.retryOnConnectionFailure(), !Intrinsics.areEqual(chain.getRequest().method(), ShareTarget.METHOD_GET));
