...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\androidx\core\util\LongSparseArrayKt.smali */
public final class LongSparseArrayKt {
    ...
    public static final <T> boolean remove(LongSparseArray<T> remove, long key, T t) {
        ...
        if (index != -1 && Intrinsics.areEqual(t, remove.valueAt(index))) {
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\androidx\core\util\LongSparseArrayKt$valueIterator$1.smali */
