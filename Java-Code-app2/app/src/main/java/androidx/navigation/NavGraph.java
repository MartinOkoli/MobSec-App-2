...
public class NavGraph extends NavDestination implements Iterable<NavDestination> {
    ...
    @Override // androidx.navigation.NavDestination
    NavDestination.DeepLinkMatch matchDeepLink(NavDeepLinkRequest request) {
    ...
    public final void addDestination(NavDestination node) {
        ...
        if (id == getId()) {
            throw new IllegalArgumentException("Destination " + node + " cannot have the same id as graph " + this);
        }
        NavDestination existingDestination = this.mNodes.get(id);
    ...
    public final void setStartDestination(int startDestId) {
        if (startDestId == getId()) {
            throw new IllegalArgumentException("Start destination " + startDestId + " cannot use the same id as the graph " + this);
        }
