...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\kotlin\time\AdjustedTimeMark.smali */
final class AdjustedTimeMark extends TimeMark {
    ...
    public double mo1265elapsedNowUwyO8pc() {
        return Duration.m1295minusLRDsOJo(this.mark.mo1265elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo1266plusLRDsOJo(double duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1296plusLRDsOJo(this.adjustment, duration), null);
    }
}
