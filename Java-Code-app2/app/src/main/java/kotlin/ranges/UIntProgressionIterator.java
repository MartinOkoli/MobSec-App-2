...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\kotlin\ranges\UIntProgressionIterator.smali */
final class UIntProgressionIterator extends UIntIterator {
    ...
    private UIntProgressionIterator(int first, int last, int step) {
        ...
        this.hasNext = z;
        this.step = UInt.m100constructorimpl(step);
    ...
    public int mo161nextUIntpVg5ArA() {
        ...
        if (value == this.finalElement) {
            ...
            this.next = UInt.m100constructorimpl(this.next + this.step);
        }
        return value;
    }
}
