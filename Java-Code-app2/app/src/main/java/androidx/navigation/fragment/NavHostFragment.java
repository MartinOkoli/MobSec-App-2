...
public class NavHostFragment extends Fragment implements NavHost {
    ...
    public void onAttachFragment(Fragment childFragment) {
        ...
        DialogFragmentNavigator dialogFragmentNavigator = (DialogFragmentNavigator) this.mNavController.getNavigatorProvider().getNavigator(DialogFragmentNavigator.class);
    ...
    public void onInflate(Context context, AttributeSet attrs, Bundle savedInstanceState) {
        ...
        TypedArray navHost = context.obtainStyledAttributes(attrs, androidx.navigation.R.styleable.NavHost);
        int graphId = navHost.getResourceId(androidx.navigation.R.styleable.NavHost_navGraph, 0);
        if (graphId != 0) {
