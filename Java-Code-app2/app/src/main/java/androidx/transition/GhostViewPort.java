...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\androidx\transition\GhostViewPort.smali */
class GhostViewPort extends ViewGroup implements GhostView {
    ...
    @Override // android.view.ViewGroup, android.view.View
    protected void onAttachedToWindow() throws IllegalArgumentException {
    ...
    @Override // android.view.ViewGroup, android.view.View
    protected void onDetachedFromWindow() throws IllegalArgumentException {
    ...
    protected void onDraw(Canvas canvas) throws SecurityException, IllegalArgumentException {
    ...
    static void copySize(View from, View to) throws SecurityException, IllegalArgumentException {
    ...
    static GhostViewPort addGhost(View view, ViewGroup viewGroup, Matrix matrix) throws SecurityException, IllegalArgumentException {
