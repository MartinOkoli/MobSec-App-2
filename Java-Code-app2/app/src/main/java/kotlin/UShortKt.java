...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\kotlin\UShortKt.smali */
public final class UShortKt {
    private static final short toUShort(byte $this$toUShort) {
        return UShort.m268constructorimpl($this$toUShort);
    }
    ...
    private static final short toUShort(int $this$toUShort) {
        return UShort.m268constructorimpl((short) $this$toUShort);
    }
