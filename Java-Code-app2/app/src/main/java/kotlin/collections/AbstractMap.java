...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\kotlin\collections\AbstractMap.smali */
public abstract class AbstractMap<K, V> implements Map<K, V>, KMappedMarker {
        ...
        if (this._values == null) {
            this._values = new AbstractCollection<V>() { // from class: kotlin.collections.AbstractMap.values.1
                ...
                public Iterator<V> iterator() {
                    ...
                    return new iterator.1<>(entryIterator);
                }
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\kotlin\collections\AbstractMap$Companion.smali */
