...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\kotlinx\coroutines\channels\AbstractChannelKt.smali */
public final class AbstractChannelKt {
    ...
    public static final <E> Object toResult(Object $this$toResult) {
        if (!($this$toResult instanceof Closed)) {
            ...
            return ValueOrClosed.m1335constructorimpl($this$toResult);
        }
        ValueOrClosed.Companion companion2 = ValueOrClosed.INSTANCE;
        Throwable cause$iv = ((Closed) $this$toResult).closeCause;
        return ValueOrClosed.m1335constructorimpl(new ValueOrClosed.Closed(cause$iv));
    }
