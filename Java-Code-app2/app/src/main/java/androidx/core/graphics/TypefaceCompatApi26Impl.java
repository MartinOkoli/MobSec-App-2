...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\androidx\core\graphics\TypefaceCompatApi26Impl.smali */
public class TypefaceCompatApi26Impl extends TypefaceCompatApi21Impl {
    ...
    private void abortCreation(Object family) throws IllegalArgumentException {
        try {
    ...
    public Typeface createFromFontFamilyFilesResourceEntry(Context context, FontResourcesParserCompat.FontFamilyFilesResourceEntry fontFamilyFilesResourceEntry, Resources resources, int i) throws IllegalArgumentException {
    ...
    @Override // androidx.core.graphics.TypefaceCompatApi21Impl, androidx.core.graphics.TypefaceCompatBaseImpl
    public Typeface createFromFontInfo(Context context, CancellationSignal cancellationSignal, FontsContractCompat.FontInfo[] fontInfoArr, int i) throws IllegalArgumentException {
    ...
    public Typeface createFromResourcesFontFile(Context context, Resources resources, int id, String path, int style) throws IllegalArgumentException {
        if (!isFontFamilyPrivateAPIAvailable()) {
