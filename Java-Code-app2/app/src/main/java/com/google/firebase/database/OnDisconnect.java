...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\com\google\firebase\database\OnDisconnect.smali */
public class OnDisconnect {
    ...
    public void setValue(Object value, DatabaseReference.CompletionListener listener) throws DatabaseException {
        onDisconnectSetInternal(value, PriorityUtilities.NullPriority(), listener);
    }

    public void setValue(Object value, String priority, DatabaseReference.CompletionListener listener) throws DatabaseException {
        onDisconnectSetInternal(value, PriorityUtilities.parsePriority(this.path, priority), listener);
    }

    public void setValue(Object value, double priority, DatabaseReference.CompletionListener listener) throws DatabaseException {
        onDisconnectSetInternal(value, PriorityUtilities.parsePriority(this.path, Double.valueOf(priority)), listener);
    }

    public void setValue(Object value, Map priority, DatabaseReference.CompletionListener listener) throws DatabaseException {
        onDisconnectSetInternal(value, PriorityUtilities.parsePriority(this.path, priority), listener);
    }

    private Task<Void> onDisconnectSetInternal(Object value, Node priority, DatabaseReference.CompletionListener optListener) throws DatabaseException {
    ...
    public void updateChildren(Map<String, Object> update, DatabaseReference.CompletionListener listener) throws DatabaseException {
        updateChildrenInternal(update, listener);
    }

    private Task<Void> updateChildrenInternal(final Map<String, Object> update, DatabaseReference.CompletionListener optListener) throws DatabaseException {
    ...
    public void removeValue(DatabaseReference.CompletionListener listener) throws DatabaseException {
