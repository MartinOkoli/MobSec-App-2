...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\com\google\android\gms\common\api\internal\zacp.smali */
        ...
        for (BasePendingResult basePendingResult : (BasePendingResult[]) this.zakz.toArray(zaky)) {
            ...
            if (basePendingResult.zam() == null) {
                ...
                if (basePendingResult.isReady()) {
                    basePendingResult.zaa(new zacr(basePendingResult, b4 == true ? 1 : 0, serviceBrokerBinder, b3 == true ? 1 : 0));
                } else if (serviceBrokerBinder != null && serviceBrokerBinder.isBinderAlive()) {
                    zacr zacrVar = new zacr(basePendingResult, b2 == true ? 1 : 0, serviceBrokerBinder, b == true ? 1 : 0);
