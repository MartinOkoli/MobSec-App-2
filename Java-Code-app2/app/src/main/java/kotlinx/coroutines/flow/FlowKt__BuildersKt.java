...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\kotlinx\coroutines\flow\FlowKt__BuildersKt.smali */
final /* synthetic */ class FlowKt__BuildersKt {
    ...
    public static final <T> Flow<T> asFlow(final Function0<? extends T> asFlow) {
        ...
        return new Flow<T>() { // from class: kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$1
            ...
            public Object collect(FlowCollector flowCollector, Continuation $completion) {
                return flowCollector.emit(asFlow.invoke(), $completion);
            }
        };
    }
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\kotlinx\coroutines\flow\FlowKt__BuildersKt$flowViaChannel$1.smali */
    ...
    public static final <T> Flow<T> flowViaChannel(int bufferSize, Function2<? super CoroutineScope, ? super SendChannel<? super T>, Unit> block) {
        Intrinsics.checkParameterIsNotNull(block, "block");
        return FlowKt.buffer(FlowKt.channelFlow(new AnonymousClass1(block, null)), bufferSize);
    }
