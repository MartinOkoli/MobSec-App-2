...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\kotlinx\coroutines\test\TestCoroutineContext.smali */
public final class TestCoroutineContext implements CoroutineContext {
        ...
        while (true) {
            ...
            synchronized (this_$iv) {
                ...
                if (first$iv != null) {
                    ...
                    threadSafeHeapNodeRemoveAtImpl = (it.time > targetTime ? 1 : (it.time == targetTime ? 0 : -1)) <= 0 ? this_$iv.removeAtImpl(0) : null;
                }
            }
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\kotlinx\coroutines\test\TestCoroutineContext$Dispatcher.smali */
    private final class Dispatcher extends EventLoop implements Delay {
        ...
        public void mo1347dispatch(CoroutineContext context, Runnable block) {
            Intrinsics.checkParameterIsNotNull(context, "context");
        ...
        public void mo1348scheduleResumeAfterDelay(long timeMillis, final CancellableContinuation<? super Unit> continuation) {
        ...
        public DisposableHandle invokeOnTimeout(long timeMillis, Runnable block) {
            ...
            return new DisposableHandle() { // from class: kotlinx.coroutines.test.TestCoroutineContext$Dispatcher$invokeOnTimeout$1
                ...
                public void dispose() {
                    TestCoroutineContext.this.queue.remove(node);
                }
            };
        }
