...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\androidx\lifecycle\SavedStateViewModelFactory.smali */
public final class SavedStateViewModelFactory extends ViewModelProvider.KeyedFactory {
    ...
    public <T extends ViewModel> T create(String str, Class<T> cls) throws SecurityException {
        ...
        try {
            ?? r3 = zIsAssignableFrom ? (ViewModel) constructorFindMatchingConstructor.newInstance(this.mApplication, savedStateHandleControllerCreate.getHandle()) : (ViewModel) constructorFindMatchingConstructor.newInstance(savedStateHandleControllerCreate.getHandle());
