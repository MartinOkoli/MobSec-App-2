...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\kotlinx\coroutines\ThreadContextElementKt.smali */
public final class ThreadContextElementKt {
    ...
    private static final Object isPresent$$forInline(ThreadLocal $this$isPresent, Continuation continuation) {
        ...
        return Boolean.valueOf(continuation2.get$context().get(new ThreadLocalKey($this$isPresent)) != null);
    }
    ...
    private static final Object ensurePresent$$forInline(ThreadLocal $this$ensurePresent, Continuation continuation) {
        InlineMarker.mark(3);
        Continuation continuation2 = null;
        if (continuation2.get$context().get(new ThreadLocalKey($this$ensurePresent)) != null) {
            return Unit.INSTANCE;
        }
