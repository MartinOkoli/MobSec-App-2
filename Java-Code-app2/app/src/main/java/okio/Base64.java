...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\okio\-Base64.smali */
public final class Base64 {
    ...
    public static final String encodeBase64(byte[] encodeBase64, byte[] map) {
        ...
        int length2 = encodeBase64.length - end;
        if (length2 == 1) {
