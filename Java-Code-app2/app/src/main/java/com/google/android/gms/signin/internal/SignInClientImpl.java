...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\com\google\android\gms\signin\internal\SignInClientImpl.smali */
public class SignInClientImpl extends GmsClient<zaf> implements com.google.android.gms.signin.zad {
    ...
    public final void zaa(zad zadVar) {
        ...
        try {
            ...
            ((zaf) getService()).zaa(new zah(new ResolveAccountRequest(accountOrDefault, this.zaoe.intValue(), savedDefaultGoogleSignInAccount)), zadVar);
        } catch (RemoteException e) {
