...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\androidx\versionedparcelable\VersionedParcel.smali */
public abstract class VersionedParcel {
    ...
    public <T> void writeSet(Set<T> val, int fieldId) throws SecurityException, IllegalArgumentException {
        writeCollection(val, fieldId);
    }

    public <T> void writeList(List<T> val, int fieldId) throws SecurityException, IllegalArgumentException {
        writeCollection(val, fieldId);
    }

    public <K, V> void writeMap(Map<K, V> val, int fieldId) throws SecurityException, IllegalArgumentException {
        setOutputField(fieldId);
        if (val == null) {
            writeInt(-1);
            return;
    ...
    private <T> void writeCollection(Collection<T> val, int fieldId) throws SecurityException, IllegalArgumentException {
        setOutputField(fieldId);
        writeCollection(val);
    }

    private <T> void writeCollection(Collection<T> collection) throws SecurityException, IllegalArgumentException {
        if (collection == null) {
            writeInt(-1);
        }
    ...
    public <T> void writeArray(T[] val, int fieldId) throws SecurityException, IllegalArgumentException {
        setOutputField(fieldId);
        writeArray(val);
    }

    /* JADX WARN: Multi-variable type inference failed */
    protected <T> void writeArray(T[] tArr) throws SecurityException, IllegalArgumentException {
        if (tArr == 0) {
            writeInt(-1);
            return;
        }
    ...
    public void writeVersionedParcelable(VersionedParcelable p, int fieldId) throws SecurityException, IllegalArgumentException {
        setOutputField(fieldId);
        writeVersionedParcelable(p);
    }

    protected void writeVersionedParcelable(VersionedParcelable p) throws SecurityException, IllegalArgumentException {
        if (p == null) {
            writeString(null);
            return;
        }
    ...
    protected <T extends VersionedParcelable> void writeToParcel(T val, VersionedParcel versionedParcel) throws SecurityException, IllegalArgumentException {
        try {
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\androidx\versionedparcelable\VersionedParcel$ParcelException.smali */
