...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\androidx\transition\ViewGroupUtils.smali */
class ViewGroupUtils {
    ...
    static int getChildDrawingOrder(ViewGroup viewGroup, int i) throws SecurityException {
        if (Build.VERSION.SDK_INT >= 29) {
