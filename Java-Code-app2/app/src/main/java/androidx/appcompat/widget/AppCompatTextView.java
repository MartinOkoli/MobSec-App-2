...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\androidx\appcompat\widget\AppCompatTextView.smali */
public class AppCompatTextView extends TextView implements TintableBackgroundView, TintableCompoundDrawablesView, AutoSizeableTextView {
    ...
    public AppCompatTextView(Context context, AttributeSet attrs, int defStyleAttr) throws Resources.NotFoundException, IllegalArgumentException {
    ...
    public void setAutoSizeTextTypeWithDefaults(int autoSizeTextType) throws IllegalArgumentException {
        if (PLATFORM_SUPPORTS_AUTOSIZE) {
