...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\kotlinx\coroutines\flow\FlowKt__MigrationKt.smali */
final /* synthetic */ class FlowKt__MigrationKt {
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\kotlinx\coroutines\flow\FlowKt__MigrationKt$onErrorReturn$2.smali */
    ...
    public static final <T> Flow<T> onErrorReturn(Flow<? extends T> onErrorReturn, T t, Function1<? super Throwable, Boolean> predicate) {
        ...
        return FlowKt.m1345catch(onErrorReturn, new AnonymousClass2(predicate, t, null));
    }
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\kotlinx\coroutines\flow\FlowKt__MigrationKt$delayFlow$1.smali */
    static final class C01701<T> extends SuspendLambda implements Function2<FlowCollector<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C01701(long j, Continuation continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> completion) {
            ...
            C01701 c01701 = new C01701(this.$timeMillis, completion);
            c01701.p$ = (FlowCollector) obj;
            return c01701;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(Object obj, Continuation<? super Unit> continuation) {
            return ((C01701) create(obj, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> Flow<T> delayFlow(Flow<? extends T> delayFlow, long timeMillis) {
        ...
        return FlowKt.onStart(delayFlow, new C01701(timeMillis, null));
    }
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\kotlinx\coroutines\flow\FlowKt__MigrationKt$delayEach$1.smali */
    ...
    public static final <T> Flow<T> delayEach(Flow<? extends T> delayEach, long timeMillis) {
        ...
        return FlowKt.onEach(delayEach, new AnonymousClass1(timeMillis, null));
    }
