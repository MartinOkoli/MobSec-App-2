...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\androidx\navigation\ActivityKt.smali */
public final class ActivityKt {
    public static final NavController findNavController(Activity findNavController, int viewId) {
        Intrinsics.checkParameterIsNotNull(findNavController, "$this$findNavController");
        NavController navControllerFindNavController = Navigation.findNavController(findNavController, viewId);
