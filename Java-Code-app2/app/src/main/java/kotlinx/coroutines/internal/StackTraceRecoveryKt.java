...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\kotlinx\coroutines\internal\StackTraceRecoveryKt.smali */
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        try {
            ...
            objM14constructorimpl = Result.m14constructorimpl(cls.getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM14constructorimpl = Result.m14constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m17exceptionOrNullimpl(objM14constructorimpl) == null) {
            obj2 = objM14constructorimpl;
        }
        ...
        try {
            ...
            objM14constructorimpl2 = Result.m14constructorimpl(cls2.getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM14constructorimpl2 = Result.m14constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m17exceptionOrNullimpl(objM14constructorimpl2) == null) {
            obj = objM14constructorimpl2;
        }
    ...
    public static final <E extends Throwable> E recoverStackTrace(E exception) {
        ...
        if (!DebugKt.getRECOVER_STACK_TRACES() || (thTryCopyException = ExceptionsConstuctorKt.tryCopyException(exception)) == null) {
            return exception;
        }
        return (E) sanitizeStackTrace(thTryCopyException);
    }
    ...
    private static final <E extends Throwable> E sanitizeStackTrace(E e) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            ...
            if (it == 0) {
                ...
                stackTraceElementArtificialFrame = stackTrace[(startIndex + it) - 1];
            }
    ...
    private static final Object recoverAndThrow$$forInline(Throwable exception, Continuation it) throws Throwable {
