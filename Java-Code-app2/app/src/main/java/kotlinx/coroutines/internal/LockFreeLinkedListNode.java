...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\kotlinx\coroutines\internal\LockFreeLinkedListNode.smali */
public class LockFreeLinkedListNode {
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\kotlinx\coroutines\internal\LockFreeLinkedListNode$CondAddOp.smali */
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\kotlinx\coroutines\internal\LockFreeLinkedListNode$makeCondAddOp$1.smali */
    public static final class AnonymousClass1 extends CondAddOp {
        ...
        public AnonymousClass1(Function0 $captured_local_variable$0, LockFreeLinkedListNode $captured_local_variable$1, LockFreeLinkedListNode $super_call_param$2) {
    ...
    */
    ...
    public final boolean addLastIf(LockFreeLinkedListNode node, Function0<Boolean> condition) {
        ...
        Intrinsics.checkParameterIsNotNull(node, "node");
        Intrinsics.checkParameterIsNotNull(condition, "condition");
        CondAddOp condAdd = new AnonymousClass1(condition, node, node);
        do {
            Object prev = getPrev();
            if (prev == null) {
                throw new TypeCastException("null cannot be cast to non-null type kotlinx.coroutines.internal.Node /* = kotlinx.coroutines.internal.LockFreeLinkedListNode */");
            ...
            iTryCondAddNext = prev2.tryCondAddNext(node, this, condAdd);
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\kotlinx\coroutines\internal\LockFreeLinkedListNode$AddLastDesc.smali */
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\kotlinx\coroutines\internal\LockFreeLinkedListNode$RemoveFirstDesc.smali */
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\kotlinx\coroutines\internal\LockFreeLinkedListNode$AbstractAtomicDesc.smali */
    public static abstract class AbstractAtomicDesc extends AtomicDesc {
        ...
        /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\kotlinx\coroutines\internal\LockFreeLinkedListNode$AbstractAtomicDesc$PrepareOp.smali */
    ...
    private final LockFreeLinkedListNode markPrev() {
        ...
        do {
            ...
            if (prev == this) {
                ...
                lockFreeLinkedListNodeFindHead = (LockFreeLinkedListNode) prev;
            }
            removedPrev = lockFreeLinkedListNodeFindHead.removed();
