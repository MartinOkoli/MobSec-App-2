...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\kotlin\UShortArrayKt.smali */
public final class UShortArrayKt {
    private static final short[] UShortArray(int size, Function1<? super Integer, UShort> function1) {
        ...
        return UShortArray.m312constructorimpl(sArr);
    }

    /* renamed from: ushortArrayOf-rL5Bavg, reason: not valid java name */
    private static final short[] m328ushortArrayOfrL5Bavg(short... elements) {
        return elements;
    }
}
