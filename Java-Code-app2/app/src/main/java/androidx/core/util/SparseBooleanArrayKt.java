...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\androidx\core\util\SparseBooleanArrayKt.smali */
public final class SparseBooleanArrayKt {
    ...
    public static final boolean containsValue(SparseBooleanArray containsValue, boolean value) {
        ...
        return containsValue.indexOfValue(value) != -1;
    }
    ...
    public static final boolean getOrElse(SparseBooleanArray getOrElse, int key, Function0<Boolean> defaultValue) {
        ...
        return it != -1 ? getOrElse.valueAt(it) : defaultValue.invoke().booleanValue();
    }
    ...
    public static final boolean remove(SparseBooleanArray remove, int key, boolean value) {
        ...
        if (index != -1 && value == remove.valueAt(index)) {
            remove.delete(key);
            return true;
        }
        return false;
