...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\android\support\customtabs\trusted\ITrustedWebActivityService.smali */
public interface ITrustedWebActivityService extends IInterface {
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\android\support\customtabs\trusted\ITrustedWebActivityService$Default.smali */
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\android\support\customtabs\trusted\ITrustedWebActivityService$Stub.smali */
    public static abstract class Stub extends Binder implements ITrustedWebActivityService {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            if (code == 9) {
                ...
                Bundle _result = extraCommand(_arg04, _arg1, _arg2);
            ...
            switch (code) {
                case 2:
                    ...
                    Bundle _result2 = notifyNotificationWithChannel(_arg0);
                    reply.writeNoException();
                    if (_result2 != null) {
                        reply.writeInt(1);
                ...
                case 4:
                    data.enforceInterface(DESCRIPTOR);
                    int _result3 = getSmallIconId();
                    reply.writeNoException();
                    reply.writeInt(_result3);
                    return true;
                case 5:
                    data.enforceInterface(DESCRIPTOR);
                    Bundle _result4 = getActiveNotifications();
                    reply.writeNoException();
                    if (_result4 != null) {
                        reply.writeInt(1);
                ...
                case 6:
                    ...
                    Bundle _result5 = areNotificationsEnabled(_arg03);
                    reply.writeNoException();
                    if (_result5 != null) {
                        reply.writeInt(1);
                ...
                case 7:
                    data.enforceInterface(DESCRIPTOR);
                    Bundle _result6 = getSmallIconBitmap();
                    reply.writeNoException();
                    if (_result6 != null) {
                        reply.writeInt(1);
        ...
        /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\android\support\customtabs\trusted\ITrustedWebActivityService$Stub$Proxy.smali */
