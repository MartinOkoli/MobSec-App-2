...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\kotlinx\coroutines\ResumeModeKt.smali */
public final class ResumeModeKt {
    ...
    public static final <T> void resumeMode(Continuation<? super T> resumeMode, T t, int mode) {
        ...
        CoroutineContext context$iv$iv = this_$iv.get$context();
    ...
    public static final <T> void resumeWithExceptionMode(Continuation<? super T> resumeWithExceptionMode, Throwable exception, int mode) {
        ...
        if (mode == 0) {
            Result.Companion companion = Result.INSTANCE;
            resumeWithExceptionMode.resumeWith(Result.m14constructorimpl(ResultKt.createFailure(exception)));
            return;
        }
        if (mode == 1) {
        ...
        try {
            ...
            Result.Companion companion2 = Result.INSTANCE;
            $this$resumeWithStackTrace$iv$iv.resumeWith(Result.m14constructorimpl(ResultKt.createFailure(StackTraceRecoveryKt.recoverStackTrace(exception, $this$resumeWithStackTrace$iv$iv))));
            Unit unit = Unit.INSTANCE;
        } finally {
            ThreadContextKt.restoreThreadContext(context$iv$iv, oldValue$iv$iv);
        }
    ...
    public static final <T> void resumeUninterceptedMode(Continuation<? super T> resumeUninterceptedMode, T t, int mode) {
        ...
        if (mode == 0) {
            ...
            Result.Companion companion = Result.INSTANCE;
            continuationIntercepted.resumeWith(Result.m14constructorimpl(t));
            return;
        }
        if (mode == 1) {
        ...
        CoroutineContext context$iv = resumeUninterceptedMode.get$context();
    ...
    public static final <T> void resumeUninterceptedWithExceptionMode(Continuation<? super T> resumeUninterceptedWithExceptionMode, Throwable exception, int mode) {
        ...
        if (mode == 0) {
            ...
            Result.Companion companion = Result.INSTANCE;
            continuationIntercepted.resumeWith(Result.m14constructorimpl(ResultKt.createFailure(exception)));
            return;
        }
        if (mode == 1) {
        ...
        CoroutineContext context$iv = resumeUninterceptedWithExceptionMode.get$context();
        Object oldValue$iv = ThreadContextKt.updateThreadContext(context$iv, null);
        try {
            Result.Companion companion3 = Result.INSTANCE;
            resumeUninterceptedWithExceptionMode.resumeWith(Result.m14constructorimpl(ResultKt.createFailure(exception)));
