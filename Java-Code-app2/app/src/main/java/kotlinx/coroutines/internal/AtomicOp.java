...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\kotlinx\coroutines\internal\AtomicOp.smali */
public abstract class AtomicOp<T> extends OpDescriptor {
    ...
    public final boolean tryDecide(Object decision) {
        if (DebugKt.getASSERTIONS_ENABLED()) {
            if (!(decision != AtomicKt.access$getNO_DECISION$p())) {
                throw new AssertionError();
            }
        }
        return _consensus$FU.compareAndSet(this, AtomicKt.access$getNO_DECISION$p(), decision);
    }
