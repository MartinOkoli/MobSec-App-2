...
public final class ActivityNavigatorExtrasKt {
    ...
    public static final ActivityNavigator.Extras ActivityNavigatorExtras(ActivityOptionsCompat activityOptions, int flags) {
        ActivityNavigator.Extras.Builder $this$apply = new ActivityNavigator.Extras.Builder();
        if (activityOptions != null) {
            $this$apply.setActivityOptions(activityOptions);
        }
        $this$apply.addFlags(flags);
        ActivityNavigator.Extras extrasBuild = $this$apply.build();
