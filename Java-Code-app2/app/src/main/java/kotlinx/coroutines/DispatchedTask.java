...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\kotlinx\coroutines\DispatchedTask.smali */
    ...
    public final void run() {
        ...
        try {
            ...
            try {
                ...
                result = Result.m14constructorimpl(Unit.INSTANCE);
            } catch (Throwable th) {
                th = th;
                Result.Companion companion2 = Result.INSTANCE;
                result = Result.m14constructorimpl(ResultKt.createFailure(th));
                handleFatalException$kotlinx_coroutines_core(fatalException, Result.m17exceptionOrNullimpl(result));
            }
        }
        ...
        try {
            ...
            if (exception == null && job != null && !job.isActive()) {
                ...
                continuation.resumeWith(Result.m14constructorimpl(ResultKt.createFailure(StackTraceRecoveryKt.recoverStackTrace(cause, continuation))));
            } else if (exception == null) {
                T successfulResult$kotlinx_coroutines_core = getSuccessfulResult$kotlinx_coroutines_core(state);
                Result.Companion companion4 = Result.INSTANCE;
                continuation.resumeWith(Result.m14constructorimpl(successfulResult$kotlinx_coroutines_core));
            } else {
                Result.Companion companion5 = Result.INSTANCE;
                continuation.resumeWith(Result.m14constructorimpl(ResultKt.createFailure(StackTraceRecoveryKt.recoverStackTrace(exception, continuation))));
            }
