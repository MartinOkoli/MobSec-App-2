...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\kotlin\collections\UCollectionsKt___UCollectionsKt.smali */
class UCollectionsKt___UCollectionsKt {
    public static final byte[] toUByteArray(Collection<UByte> toUByteArray) {
        ...
        byte[] result = UByteArray.m75constructorimpl(toUByteArray.size());
        int index = 0;
        Iterator<UByte> it = toUByteArray.iterator();
        while (it.hasNext()) {
            byte element = it.next().getData();
            UByteArray.m86setVurrAj0(result, index, element);
            index++;
        }
        return result;
    }
    ...
    public static final int[] toUIntArray(Collection<UInt> toUIntArray) {
        ...
        int[] result = UIntArray.m145constructorimpl(toUIntArray.size());
        int index = 0;
        Iterator<UInt> it = toUIntArray.iterator();
        while (it.hasNext()) {
            int element = it.next().getData();
            UIntArray.m156setVXSXFK8(result, index, element);
            index++;
        }
        return result;
    }
    ...
    public static final short[] toUShortArray(Collection<UShort> toUShortArray) {
        ...
        short[] result = UShortArray.m311constructorimpl(toUShortArray.size());
        int index = 0;
        Iterator<UShort> it = toUShortArray.iterator();
        while (it.hasNext()) {
            short element = it.next().getData();
            UShortArray.m322set01HTLdE(result, index, element);
            index++;
        }
        return result;
    }
    ...
    public static final int sumOfUInt(Iterable<UInt> sum) {
        ...
        while (it.hasNext()) {
            int element = it.next().getData();
            sum2 = UInt.m100constructorimpl(sum2 + element);
        }
        return sum2;
    }
    ...
    public static final int sumOfUByte(Iterable<UByte> sum) {
        ...
        while (it.hasNext()) {
            byte element = it.next().getData();
            sum2 = UInt.m100constructorimpl(UInt.m100constructorimpl(element & UByte.MAX_VALUE) + sum2);
        }
        return sum2;
    }
    ...
    public static final int sumOfUShort(Iterable<UShort> sum) {
        ...
        while (it.hasNext()) {
            short element = it.next().getData();
            sum2 = UInt.m100constructorimpl(UInt.m100constructorimpl(65535 & element) + sum2);
        }
        return sum2;
    }
}
