...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\com\google\firebase\database\connection\Connection.smali */
class Connection implements WebsocketConnection.Delegate {
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\com\google\firebase\database\connection\Connection$Delegate.smali */
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\com\google\firebase\database\connection\Connection$DisconnectReason.smali */
    public enum DisconnectReason {
        SERVER_RESET,
        OTHER
    }

    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\com\google\firebase\database\connection\Connection$State.smali */
    private enum State {
        REALTIME_CONNECTING,
        REALTIME_CONNECTED,
    ...
    public void onMessage(Map<String, Object> message) {
        try {
            ...
            if (messageType != null) {
                ...
                if (messageType.equals(SERVER_CONTROL_MESSAGE)) {
