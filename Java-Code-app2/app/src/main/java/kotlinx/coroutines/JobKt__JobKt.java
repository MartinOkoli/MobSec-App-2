...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\kotlinx\coroutines\JobKt__JobKt.smali */
public final /* synthetic */ class JobKt__JobKt {
    ...
    public static final /* synthetic */ Job m1330Job(Job parent) {
        return JobKt.Job(parent);
    }

    /* renamed from: Job$default, reason: collision with other method in class */
    public static /* synthetic */ Job m1331Job$default(Job job, int i, Object obj) {
        if ((i & 1) != 0) {
            job = (Job) null;
        }
        return m1330Job(job);
