...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\kotlinx\coroutines\android\HandlerDispatcherKt.smali */
public final class HandlerDispatcherKt {
    ...
    public static final Handler asHandler(Looper asHandler, boolean async) throws IllegalAccessException, NoSuchMethodException, InstantiationException, SecurityException, IllegalArgumentException, InvocationTargetException {
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            Object objInvoke = factoryMethod.invoke(null, asHandler);
            if (objInvoke != null) {
        ...
        try {
            ...
            Object objNewInstance = constructor.newInstance(asHandler, null, true);
    ...
    static {
        ...
        try {
            ...
            objM14constructorimpl = Result.m14constructorimpl(new HandlerContext(asHandler(mainLooper, true), "Main"));
        } catch (Throwable th) {
        ...
        Main = (HandlerDispatcher) objM14constructorimpl;
    }
    ...
    public static final Object awaitFrame(Continuation<? super Long> continuation) {
        ...
        Dispatchers.getMain().mo1347dispatch(EmptyCoroutineContext.INSTANCE, new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$$special$$inlined$Runnable$1
    ...
    public static final void postFrameCallback(Choreographer choreographer2, final CancellableContinuation<? super Long> cancellableContinuation) {
        choreographer2.postFrameCallback(new Choreographer.FrameCallback() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt.postFrameCallback.1
            ...
            public final void doFrame(long nanos) {
                CancellableContinuation $this$with = cancellableContinuation;
