...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\kotlinx\coroutines\SupervisorKt.smali */
public final class SupervisorKt {
    ...
    public static final /* synthetic */ Job m1332SupervisorJob(Job parent) {
        return SupervisorJob(parent);
    }

    /* renamed from: SupervisorJob$default, reason: collision with other method in class */
    public static /* synthetic */ Job m1333SupervisorJob$default(Job job, int i, Object obj) {
        if ((i & 1) != 0) {
            job = (Job) null;
        }
        return m1332SupervisorJob(job);
    }
