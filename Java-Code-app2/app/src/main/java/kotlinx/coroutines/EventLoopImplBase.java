...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\kotlinx\coroutines\EventLoopImplBase.smali */
public abstract class EventLoopImplBase extends EventLoopImplPlatform implements Delay {
    ...
    public void mo1348scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
            ...
            do {
                synchronized (delayed) {
                    ...
                    if (first$iv != null) {
                        ...
                        delayedTaskRemoveAtImpl = zEnqueueImpl ? delayed.removeAtImpl(0) : null;
                    }
                }
    ...
    public final void mo1347dispatch(CoroutineContext context, Runnable block) {
    ...
    private final boolean enqueueImpl(Runnable task) {
        while (true) {
            ...
            if (queue == null) {
                ...
                int iAddLast = ((LockFreeTaskQueueCore) queue).addLast(task);
                if (iAddLast != 0) {
                    if (iAddLast == 1) {
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\kotlinx\coroutines\EventLoopImplBase$DelayedTask.smali */
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\kotlinx\coroutines\EventLoopImplBase$DelayedResumeTask.smali */
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\kotlinx\coroutines\EventLoopImplBase$DelayedRunnableTask.smali */
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\kotlinx\coroutines\EventLoopImplBase$DelayedTaskQueue.smali */
