...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\okhttp3\RequestBody.smali */
public abstract class RequestBody {
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\okhttp3\RequestBody$Companion.smali */
    public static final class Companion {
        ...
        @JvmStatic
        public final RequestBody create(byte[] toRequestBody, MediaType contentType, int offset, int byteCount) {
            Intrinsics.checkNotNullParameter(toRequestBody, "$this$toRequestBody");
            Util.checkOffsetAndCount(toRequestBody.length, offset, byteCount);
            return new toRequestBody.2(toRequestBody, contentType, byteCount, offset);
        }
