...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\kotlinx\coroutines\ExecutorCoroutineDispatcherBase.smali */
public abstract class ExecutorCoroutineDispatcherBase extends ExecutorCoroutineDispatcher implements Delay {
    ...
    public void mo1348scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
        ...
        if (future != null) {
            ...
            DefaultExecutor.INSTANCE.mo1348scheduleResumeAfterDelay(timeMillis, continuation);
        }
    }
