...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\com\google\crypto\tink\streamingaead\AesGcmHkdfStreamingKeyManager.smali */
public final class AesGcmHkdfStreamingKeyManager extends KeyTypeManager<AesGcmHkdfStreamingKey> {
    ...
    public AesGcmHkdfStreamingKey mo6parseKey(ByteString byteString) throws InvalidProtocolBufferException {
        ...
        return new KeyTypeManager.KeyFactory<AesGcmHkdfStreamingKeyFormat, AesGcmHkdfStreamingKey>(AesGcmHkdfStreamingKeyFormat.class) { // from class: com.google.crypto.tink.streamingaead.AesGcmHkdfStreamingKeyManager.2
            ...
            public AesGcmHkdfStreamingKey deriveKey(AesGcmHkdfStreamingKeyFormat format, InputStream inputStream) throws GeneralSecurityException {
                ...
                try {
                    ...
                    return AesGcmHkdfStreamingKey.newBuilder().setKeyValue(ByteString.copyFrom(pseudorandomness)).setParams(format.getParams()).setVersion(AesGcmHkdfStreamingKeyManager.this.getVersion()).build();
                } catch (IOException e) {
