...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\kotlinx\coroutines\sync\SemaphoreSegment.smali */
final class SemaphoreSegment extends Segment<SemaphoreSegment> {
    ...
    public final boolean cancel(int index) {
        Object value$iv = this.acquirers.getAndSet(index, SemaphoreKt.CANCELLED);
        boolean cancelled = value$iv != SemaphoreKt.RESUMED;
