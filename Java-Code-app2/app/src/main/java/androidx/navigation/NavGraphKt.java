...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\androidx\navigation\NavGraphKt.smali */
public final class NavGraphKt {
    public static final NavDestination get(NavGraph get, int id) {
        Intrinsics.checkParameterIsNotNull(get, "$this$get");
        NavDestination navDestinationFindNode = get.findNode(id);
        if (navDestinationFindNode != null) {
            return navDestinationFindNode;
        }
        throw new IllegalArgumentException("No destination for " + id + " was found in " + get);
    }

    public static final boolean contains(NavGraph contains, int id) {
        Intrinsics.checkParameterIsNotNull(contains, "$this$contains");
        return contains.findNode(id) != null;
    }
