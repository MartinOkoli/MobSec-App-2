...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\kotlin\ResultKt.smali */
public final class ResultKt {
    ...
    private static final <R> Object runCatching(Function0<? extends R> function0) {
        try {
            ...
            return Result.m14constructorimpl(createFailure(e));
        }
    }
    ...
    private static final <R, T extends R> R getOrElse(Object obj, Function1<? super Throwable, ? extends R> function1) {
        Throwable exception = Result.m17exceptionOrNullimpl(obj);
        if (exception == null) {
            return obj;
        }
    ...
    private static final <R, T> R fold(Object $this$fold, Function1<? super T, ? extends R> function1, Function1<? super Throwable, ? extends R> function12) {
        Throwable exception = Result.m17exceptionOrNullimpl($this$fold);
        if (exception == null) {
    ...
    private static final <R, T> Object map(Object $this$map, Function1<? super T, ? extends R> function1) {
        if (!Result.m21isSuccessimpl($this$map)) {
            return Result.m14constructorimpl($this$map);
        }
        Result.Companion companion = Result.INSTANCE;
        return Result.m14constructorimpl(function1.invoke($this$map));
    }

    private static final <R, T> Object mapCatching(Object $this$mapCatching, Function1<? super T, ? extends R> function1) {
        if (Result.m21isSuccessimpl($this$mapCatching)) {
            try {
                Result.Companion companion = Result.INSTANCE;
                Object $this$runCatching = Result.m14constructorimpl(function1.invoke($this$mapCatching));
        ...
        return Result.m14constructorimpl($this$mapCatching);
    }

    private static final <R, T extends R> Object recover(Object $this$recover, Function1<? super Throwable, ? extends R> function1) {
        Throwable exception = Result.m17exceptionOrNullimpl($this$recover);
        if (exception == null) {
            return $this$recover;
        }
        Result.Companion companion = Result.INSTANCE;
        return Result.m14constructorimpl(function1.invoke(exception));
    }
    ...
    private static final <R, T extends R> Object recoverCatching(Object $this$recoverCatching, Function1<? super Throwable, ? extends R> function1) {
        Throwable exception = Result.m17exceptionOrNullimpl($this$recoverCatching);
        if (exception == null) {
            return $this$recoverCatching;
        }
        try {
            Result.Companion companion = Result.INSTANCE;
            Object $this$runCatching = Result.m14constructorimpl(function1.invoke(exception));
            return $this$runCatching;
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            return Result.m14constructorimpl(createFailure(th));
    ...
    private static final <T> Object onFailure(Object $this$onFailure, Function1<? super Throwable, Unit> function1) {
        Throwable it = Result.m17exceptionOrNullimpl($this$onFailure);
        if (it != null) {
            function1.invoke(it);
        }
    ...
    private static final <T> Object onSuccess(Object $this$onSuccess, Function1<? super T, Unit> function1) {
        if (Result.m21isSuccessimpl($this$onSuccess)) {
