...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\kotlin\UnsignedKt.smali */
public final class UnsignedKt {
    ...
    public static final int m329uintDivideJ1ME1BU(int v1, int v2) {
        return UInt.m100constructorimpl((int) ((v1 & 4294967295L) / (4294967295L & v2)));
    }

    /* renamed from: uintRemainder-J1ME1BU, reason: not valid java name */
    public static final int m330uintRemainderJ1ME1BU(int v1, int v2) {
        return UInt.m100constructorimpl((int) ((v1 & 4294967295L) % (4294967295L & v2)));
    }

    /* renamed from: ulongDivide-eb3DHEI, reason: not valid java name */
    public static final long m331ulongDivideeb3DHEI(long v1, long v2) {
        if (v2 < 0) {
    ...
    public static final long m332ulongRemaindereb3DHEI(long v1, long v2) {
        long j = 0;
        if (v2 < 0) {
    ...
    public static final int doubleToUInt(double v) {
        if (!Double.isNaN(v) && v > uintToDouble(0)) {
            ...
            return v <= d ? UInt.m100constructorimpl((int) v) : UInt.m100constructorimpl(UInt.m100constructorimpl((int) (v - d)) + UInt.m100constructorimpl(Integer.MAX_VALUE));
        }
        return 0;
    }
