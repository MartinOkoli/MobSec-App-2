...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\kotlin\time\TimedValue.smali */
public final /* data */ class TimedValue<T> {
    ...
    public static /* synthetic */ TimedValue m1323copyRFiDyg4$default(TimedValue timedValue, Object obj, double d, int i, Object obj2) {
        if ((i & 1) != 0) {
        ...
        return timedValue.m1325copyRFiDyg4(obj, d);
    }
    ...
    public final TimedValue<T> m1325copyRFiDyg4(T value, double duration) {
    ...
    public String toString() {
        return "TimedValue(value=" + this.value + ", duration=" + Duration.m1310toStringimpl(this.duration) + ")";
    }
    ...
    public final double m1326getDurationUwyO8pc() {
        return this.duration;
    }
