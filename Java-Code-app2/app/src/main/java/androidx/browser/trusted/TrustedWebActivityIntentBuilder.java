...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\androidx\browser\trusted\TrustedWebActivityIntentBuilder.smali */
public class TrustedWebActivityIntentBuilder {
    ...
    public TrustedWebActivityIntent build(CustomTabsSession session) throws SecurityException {
        if (session == null) {
