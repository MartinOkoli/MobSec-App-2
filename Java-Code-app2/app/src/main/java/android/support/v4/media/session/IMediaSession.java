...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\android\support\v4\media\session\IMediaSession.smali */
public interface IMediaSession extends IInterface {
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\android\support\v4\media\session\IMediaSession$Stub.smali */
    public static abstract class Stub extends Binder implements IMediaSession {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            if (i == 51) {
                ...
                rateWithExtras(ratingCompatCreateFromParcel, bundle);
            ...
            switch (i) {
                case 1:
                    ...
                    sendCommand(string, bundle2, resultReceiverWrapperCreateFromParcel);
                    parcel2.writeNoException();
                    return true;
                case 2:
                    parcel.enforceInterface(DESCRIPTOR);
                ...
                case 14:
                    ...
                    playFromMediaId(string2, bundle3);
                    parcel2.writeNoException();
                    return true;
                case 15:
                    parcel.enforceInterface(DESCRIPTOR);
                    ...
                    playFromSearch(string3, bundle4);
                    parcel2.writeNoException();
                    return true;
                case 16:
                    parcel.enforceInterface(DESCRIPTOR);
                ...
                case 25:
                    ...
                    rate(ratingCompatCreateFromParcel2);
                    parcel2.writeNoException();
                    return true;
                case 26:
                    parcel.enforceInterface(DESCRIPTOR);
                    ...
                    sendCustomAction(string4, bundle6);
                    parcel2.writeNoException();
                    return true;
                case 27:
                    parcel.enforceInterface(DESCRIPTOR);
                ...
                case 34:
                    ...
                    prepareFromMediaId(string5, bundle7);
                    parcel2.writeNoException();
                    return true;
                case 35:
                    parcel.enforceInterface(DESCRIPTOR);
                    ...
                    prepareFromSearch(string6, bundle8);
                    parcel2.writeNoException();
                    return true;
                case 36:
                    parcel.enforceInterface(DESCRIPTOR);
        ...
        /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\android\support\v4\media\session\IMediaSession$Stub$Proxy.smali */
