...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\androidx\appcompat\widget\ActivityChooserView.smali */
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    public ActivityChooserView(Context context, AttributeSet attrs, int defStyle) {
        ...
        expandButton.setOnTouchListener(new ForwardingListener(expandButton) { // from class: androidx.appcompat.widget.ActivityChooserView.4
            ...
            @Override // androidx.appcompat.widget.ForwardingListener
            protected boolean onForwardingStarted() throws IllegalArgumentException {
    ...
    public void setActivityChooserModel(ActivityChooserModel dataModel) throws IllegalArgumentException {
    ...
    void showPopupUnchecked(int maxActivityCount) throws IllegalArgumentException {
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\androidx\appcompat\widget\ActivityChooserView$Callbacks.smali */
    private class Callbacks implements AdapterView.OnItemClickListener, View.OnClickListener, View.OnLongClickListener, PopupWindow.OnDismissListener {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) throws IllegalArgumentException {
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\androidx\appcompat\widget\ActivityChooserView$ActivityChooserViewAdapter.smali */
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\androidx\appcompat\widget\ActivityChooserView$InnerLayout.smali */
