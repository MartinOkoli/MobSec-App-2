...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\kotlinx\coroutines\internal\ConcurrentKt.smali */
public final class ConcurrentKt {
    ...
    public static final <E> Set<E> identitySet(int expectedSize) {
        Set<E> setNewSetFromMap = Collections.newSetFromMap(new IdentityHashMap(expectedSize));
