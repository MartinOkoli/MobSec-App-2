...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\kotlinx\coroutines\flow\internal\ChannelFlowOperator.smali */
public abstract class ChannelFlowOperator<S, T> extends ChannelFlow<T> {
    ...
    final /* synthetic */ Object collectWithContextUndispatched(FlowCollector<? super T> flowCollector, CoroutineContext newContext, Continuation<? super Unit> continuation) {
        ...
        return ChannelFlowKt.withContextUndispatched$default(newContext, null, new AnonymousClass2(null), originalContextCollector, continuation, 2, null);
    }
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\kotlinx\coroutines\flow\internal\ChannelFlowOperator$collectWithContextUndispatched$2.smali */
    ...
    static /* synthetic */ Object collectTo$suspendImpl(ChannelFlowOperator channelFlowOperator, ProducerScope scope, Continuation $completion) {
        return channelFlowOperator.flowCollect((FlowCollector) new SendingCollector(scope), $completion);
    }
