...
public final class NavDeepLinkBuilder {
    ...
    private void fillInIntent() {
        ...
        if (node == null) {
            ...
            throw new IllegalArgumentException("Navigation destination " + dest + " cannot be found in the navigation graph " + this.mGraph);
        }
    ...
    public TaskStackBuilder createTaskStackBuilder() throws PackageManager.NameNotFoundException {
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\androidx\navigation\NavDeepLinkBuilder$PermissiveNavigatorProvider.smali */
