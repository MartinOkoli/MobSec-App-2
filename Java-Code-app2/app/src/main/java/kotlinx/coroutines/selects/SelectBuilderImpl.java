...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\kotlinx\coroutines\selects\SelectBuilderImpl.smali */
public final class SelectBuilderImpl<R> extends LockFreeLinkedListHead implements SelectBuilder<R>, SelectInstance<R>, Continuation<R>, CoroutineStackFrame {
    ...
    public void resumeWith(Object result) {
        ...
        while (true) {
            ...
            if (result$iv == SelectKt.UNDECIDED) {
                ...
                if (_result$FU.compareAndSet(this, IntrinsicsKt.getCOROUTINE_SUSPENDED(), SelectKt.RESUMED)) {
                    if (Result.m20isFailureimpl(result)) {
                        Continuation $this$resumeWithStackTrace$iv = this.uCont;
                        Throwable exception$iv = Result.m17exceptionOrNullimpl(result);
                        if (exception$iv == null) {
                            Intrinsics.throwNpe();
                        }
                        Result.Companion companion = Result.INSTANCE;
                        $this$resumeWithStackTrace$iv.resumeWith(Result.m14constructorimpl(ResultKt.createFailure(StackTraceRecoveryKt.recoverStackTrace(exception$iv, $this$resumeWithStackTrace$iv))));
                        return;
                    }
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\kotlinx\coroutines\selects\SelectBuilderImpl$SelectOnCancelling.smali */
    ...
    public final void handleBuilderException(Throwable e) {
        ...
        if (trySelect(null)) {
            Result.Companion companion = Result.INSTANCE;
            resumeWith(Result.m14constructorimpl(ResultKt.createFailure(e)));
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\kotlinx\coroutines\selects\SelectBuilderImpl$AtomicSelectOp.smali */
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\kotlinx\coroutines\selects\SelectBuilderImpl$DisposeNode.smali */
