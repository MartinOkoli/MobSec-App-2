...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\androidx\constraintlayout\motion\utils\ArcCurveFit.smali */
class ArcCurveFit extends CurveFit {
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\androidx\constraintlayout\motion\utils\ArcCurveFit$Arc.smali */
    private static class Arc {
        ...
        Arc(int mode, double t1, double t2, double x1, double y1, double x2, double y2) {
            ...
            this.mEllipseA = (z ? -1 : 1) * dx;
            this.mEllipseB = (z ? 1 : -1) * dy;
