...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\kotlinx\coroutines\channels\AbstractChannel.smali */
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    final /* synthetic */ <R> Object receiveSuspend(int receiveMode, Continuation<? super R> continuation) {
        ...
        while (true) {
            ...
            if (result != AbstractChannelKt.POLL_FAILED) {
                Object objResumeValue = receiveElement.resumeValue(result);
                Result.Companion companion = Result.INSTANCE;
                cont.resumeWith(Result.m14constructorimpl(objResumeValue));
                break;
            }
        }
        ...
        if (isBufferAlwaysEmpty()) {
            ...
            while (true) {
                ...
                if (prev2 != null) {
                    ...
                    int iTryCondAddNext = prev$iv2.tryCondAddNext(receive, this_$iv2, condAdd$iv);
    ...
    public final Object receiveOrClosed(Continuation<? super ValueOrClosed<? extends E>> continuation) {
        Object objM1335constructorimpl;
        Object result = pollInternal();
        if (result == AbstractChannelKt.POLL_FAILED) {
        ...
        if (!(result instanceof Closed)) {
            ...
            objM1335constructorimpl = ValueOrClosed.m1335constructorimpl(result);
        } else {
            ValueOrClosed.Companion companion2 = ValueOrClosed.INSTANCE;
            Throwable cause$iv$iv = ((Closed) result).closeCause;
            objM1335constructorimpl = ValueOrClosed.m1335constructorimpl(new ValueOrClosed.Closed(cause$iv$iv));
        }
        Object $this$toResult$iv = ValueOrClosed.m1334boximpl(objM1335constructorimpl);
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\kotlinx\coroutines\channels\AbstractChannel$TryPollDesc.smali */
        ...
        while (!select.isSelected()) {
            if (isEmpty()) {
                ...
                if (pollResult == AbstractChannelKt.POLL_FAILED) {
                    ...
                    UndispatchedKt.startCoroutineUnintercepted(block, ValueOrClosed.m1334boximpl(ValueOrClosed.m1335constructorimpl(new ValueOrClosed.Closed(cause$iv))), select.getCompletion());
                } else {
                    ValueOrClosed.Companion companion2 = ValueOrClosed.INSTANCE;
                    UndispatchedKt.startCoroutineUnintercepted(block, ValueOrClosed.m1334boximpl(ValueOrClosed.m1335constructorimpl(pollResult)), select.getCompletion());
                    return;
                }
            }
        }
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\kotlinx\coroutines\channels\AbstractChannel$RemoveReceiveOnCancel.smali */
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\kotlinx\coroutines\channels\AbstractChannel$Itr.smali */
            ...
            while (true) {
                ...
                if (result instanceof Closed) {
                    if (((Closed) result).closeCause == null) {
                        ...
                        Result.Companion companion = Result.INSTANCE;
                        cont.resumeWith(Result.m14constructorimpl(boolBoxBoolean));
                    } else {
                        Throwable receiveException = ((Closed) result).getReceiveException();
                        Result.Companion companion2 = Result.INSTANCE;
                        cont.resumeWith(Result.m14constructorimpl(ResultKt.createFailure(receiveException)));
                    }
                } else if (result != AbstractChannelKt.POLL_FAILED) {
                    Boolean boolBoxBoolean2 = Boxing.boxBoolean(true);
                    Result.Companion companion3 = Result.INSTANCE;
                    cont.resumeWith(Result.m14constructorimpl(boolBoxBoolean2));
                    break;
                }
            }
            Object result2 = cancellable$iv.getResult();
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\kotlinx\coroutines\channels\AbstractChannel$ReceiveElement.smali */
    private static final class ReceiveElement<E> extends Receive<E> {
        ...
        public final Object resumeValue(E value) {
            if (this.receiveMode == 2) {
                ValueOrClosed.Companion companion = ValueOrClosed.INSTANCE;
                return ValueOrClosed.m1334boximpl(ValueOrClosed.m1335constructorimpl(value));
            }
            return value;
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            ...
            if (this.receiveMode != 1 || closed.closeCause != null) {
                if (this.receiveMode != 2) {
                    ...
                    Result.Companion companion = Result.INSTANCE;
                    cancellableContinuation.resumeWith(Result.m14constructorimpl(ResultKt.createFailure(receiveException)));
                    return;
                }
                CancellableContinuation<Object> cancellableContinuation2 = this.cont;
                ValueOrClosed.Companion companion2 = ValueOrClosed.INSTANCE;
                Throwable cause$iv$iv = closed.closeCause;
                ValueOrClosed valueOrClosedM1334boximpl = ValueOrClosed.m1334boximpl(ValueOrClosed.m1335constructorimpl(new ValueOrClosed.Closed(cause$iv$iv)));
                Result.Companion companion3 = Result.INSTANCE;
                cancellableContinuation2.resumeWith(Result.m14constructorimpl(valueOrClosedM1334boximpl));
                return;
            }
            CancellableContinuation<Object> cancellableContinuation3 = this.cont;
            Result.Companion companion4 = Result.INSTANCE;
            cancellableContinuation3.resumeWith(Result.m14constructorimpl(null));
        }
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\kotlinx\coroutines\channels\AbstractChannel$ReceiveHasNext.smali */
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\kotlinx\coroutines\channels\AbstractChannel$ReceiveSelect.smali */
    private static final class ReceiveSelect<R, E> extends Receive<E> implements DisposableHandle {
        ...
        public void completeResumeReceive(Object token) {
            ...
            if (this.receiveMode != 2) {
                objM1334boximpl = value;
            } else {
                ValueOrClosed.Companion companion = ValueOrClosed.INSTANCE;
                objM1334boximpl = ValueOrClosed.m1334boximpl(ValueOrClosed.m1335constructorimpl(value));
            }
            ContinuationKt.startCoroutine(function2, objM1334boximpl, this.select.getCompletion());
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            ...
            if (this.select.trySelect(null)) {
                ...
                if (i == 2) {
                    ...
                    ContinuationKt.startCoroutine(function2, ValueOrClosed.m1334boximpl(ValueOrClosed.m1335constructorimpl(new ValueOrClosed.Closed(cause$iv))), this.select.getCompletion());
                }
            }
        }
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\kotlinx\coroutines\channels\AbstractChannel$IdempotentTokenValue.smali */
