...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\kotlinx\coroutines\DispatchedContinuation.smali */
public final class DispatchedContinuation<T> extends DispatchedTask<T> implements CoroutineStackFrame, Continuation<T> {
    ...
    public void resumeWith(Object result) {
        ...
        if (this.dispatcher.isDispatchNeeded(context)) {
            this._state = state;
            this.resumeMode = 0;
            this.dispatcher.mo1347dispatch(context, this);
            return;
        }
    ...
    public final void resumeCancellable(T value) {
        ...
        if (this.dispatcher.isDispatchNeeded(get$context())) {
            this._state = value;
            this.resumeMode = 1;
            this.dispatcher.mo1347dispatch(get$context(), this);
            return;
        }
        ...
        try {
            ...
            if (!z) {
                CoroutineContext context$iv$iv = get$context();
                ...
                try {
                    ...
                    continuation.resumeWith(Result.m14constructorimpl(value));
                    Unit unit = Unit.INSTANCE;
    ...
    public final void resumeCancellableWithException(Throwable exception) {
        ...
        CoroutineContext context = this.continuation.get$context();
        CompletedExceptionally state = new CompletedExceptionally(exception, false, 2, null);
        if (this.dispatcher.isDispatchNeeded(context)) {
        ...
        eventLoop$kotlinx_coroutines_core.incrementUseCount(true);
        try {
            Job job$iv2 = (Job) get$context().get(Job.INSTANCE);
            if (job$iv2 != null && !job$iv2.isActive()) {
                CancellationException cancellationException = job$iv2.getCancellationException();
                Result.Companion companion = Result.INSTANCE;
                resumeWith(Result.m14constructorimpl(ResultKt.createFailure(cancellationException)));
                job$iv = 1;
            } else {
            ...
            if (job$iv == null) {
                ...
                try {
                    ...
                    $this$resumeWithStackTrace$iv$iv.resumeWith(Result.m14constructorimpl(ResultKt.createFailure(exception$iv$iv)));
                    Unit unit = Unit.INSTANCE;
                    InlineMarker.finallyStart(1);
                    ThreadContextKt.restoreThreadContext(context$iv$iv, oldValue$iv$iv);
                    InlineMarker.finallyEnd(1);
    ...
    public final void resumeUndispatchedWithException(Throwable exception) {
        ...
        try {
            ...
            Result.Companion companion = Result.INSTANCE;
            $this$resumeWithStackTrace$iv.resumeWith(Result.m14constructorimpl(ResultKt.createFailure(StackTraceRecoveryKt.recoverStackTrace(exception, $this$resumeWithStackTrace$iv))));
            Unit unit = Unit.INSTANCE;
        } finally {
            InlineMarker.finallyStart(1);
            ThreadContextKt.restoreThreadContext(context$iv, oldValue$iv);
