...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\kotlin\coroutines\intrinsics\IntrinsicsKt__IntrinsicsJvmKt.smali */
public class IntrinsicsKt__IntrinsicsJvmKt {
    ...
    public static final <R, T> Continuation<Unit> createCoroutineUnintercepted(final Function2<? super R, ? super Continuation<? super T>, ? extends Object> createCoroutineUnintercepted, final R r, Continuation<? super T> completion) {
        ...
        if (probeCompletion != null) {
            return new IntrinsicsKt__IntrinsicsJvmKt$createCoroutineUnintercepted$.inlined.createCoroutineFromSuspendFunction.IntrinsicsKt__IntrinsicsJvmKt.4<>(probeCompletion, context$iv, probeCompletion, context$iv, createCoroutineUnintercepted, r);
        }
        throw new NullPointerException("null cannot be cast to non-null type kotlin.coroutines.Continuation<kotlin.Any?>");
    }
    ...
    private static final <T> Continuation<Unit> createCoroutineFromSuspendFunction$IntrinsicsKt__IntrinsicsJvmKt(final Continuation<? super T> continuation, final Function1<? super Continuation<? super T>, ? extends Object> function1) {
        ...
        if (continuation != null) {
            return new createCoroutineFromSuspendFunction.2<>(function1, continuation, context, continuation, context);
        }
        throw new NullPointerException("null cannot be cast to non-null type kotlin.coroutines.Continuation<kotlin.Any?>");
    }
}
