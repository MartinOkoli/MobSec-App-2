...
import androidx.core.animation.AnimatorKt$doOnPause$;
...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\androidx\core\animation\AnimatorKt.smali */
public final class AnimatorKt {
    ...
    public static final Animator.AnimatorPauseListener doOnPause(Animator doOnPause, Function1<? super Animator, Unit> action) {
        Intrinsics.checkParameterIsNotNull(doOnPause, "$this$doOnPause");
        Intrinsics.checkParameterIsNotNull(action, "action");
        Animator.AnimatorPauseListener animatorPauseListener = new AnimatorKt$doOnPause$.inlined.addPauseListener.1(action);
