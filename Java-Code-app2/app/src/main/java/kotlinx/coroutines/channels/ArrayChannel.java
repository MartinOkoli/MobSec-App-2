...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\kotlinx\coroutines\channels\ArrayChannel.smali */
        ...
        try {
            ...
            if (size < this.capacity) {
                ...
                if (size == 0) {
                    ...
                    receiveOrClosedTakeFirstReceiveOrPeekClosed.completeResumeReceive(token);
                    if (receiveOrClosedTakeFirstReceiveOrPeekClosed == null) {
                        Intrinsics.throwNpe();
                    }
        ...
        try {
            ...
            if (size == this.capacity) {
                ...
                if (failure == null) {
                    ...
                    replacement = result.getPollResult();
            ...
            if (token != null) {
                ...
                result.completeResumeSend(token);
            }
            return result2;
        } finally {
            reentrantLock.unlock();
