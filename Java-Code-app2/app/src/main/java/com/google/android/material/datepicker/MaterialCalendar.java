...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\com\google\android\material\datepicker\MaterialCalendar.smali */
public final class MaterialCalendar<S> extends PickerFragment<S> {
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\com\google\android\material\datepicker\MaterialCalendar$CalendarSelector.smali */
    enum CalendarSelector {
        DAY,
        YEAR
    }

    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\com\google\android\material\datepicker\MaterialCalendar$OnDayClickListener.smali */
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.calendarConstraints = activeBundle.getParcelable(CALENDAR_CONSTRAINTS_KEY);
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) throws Resources.NotFoundException {
        ...
        SmoothCalendarLayoutManager layoutManager = new 2(this, getContext(), orientation, false, orientation);
