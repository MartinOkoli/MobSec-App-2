...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\kotlin\sequences\SequenceBuilderIterator.smali */
final class SequenceBuilderIterator<T> extends SequenceScope<T> implements Iterator<T>, Continuation<Unit>, KMappedMarker {
    ...
    public boolean hasNext() throws Throwable {
        while (true) {
            ...
            step.resumeWith(Result.m14constructorimpl(unit));
        }
    }
