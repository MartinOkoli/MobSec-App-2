...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\androidx\transition\ViewUtilsBase.smali */
class ViewUtilsBase {
    ...
    public void setLeftTopRightBottom(View v, int left, int top, int right, int bottom) throws SecurityException, IllegalArgumentException {
        fetchSetFrame();
    ...
    public void setTransitionVisibility(View view, int visibility) throws IllegalArgumentException {
