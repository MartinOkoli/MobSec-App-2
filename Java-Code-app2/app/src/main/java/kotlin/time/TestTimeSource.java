...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\kotlin\time\TestTimeSource.smali */
public final class TestTimeSource extends AbstractLongTimeSource {
    ...
    public final void m1321plusAssignLRDsOJo(double duration) {
        long newReading;
        double delta = Duration.m1304toDoubleimpl(duration, getUnit());
    ...
    private final void m1320overflowLRDsOJo(double duration) {
        throw new IllegalStateException("TestTimeSource will overflow if its reading " + this.reading + "ns is advanced by " + Duration.m1310toStringimpl(duration) + '.');
    }
}
