...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\androidx\lifecycle\SavedStateHandleController.smali */
final class SavedStateHandleController implements LifecycleEventObserver {
    ...
    /* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\androidx\lifecycle\SavedStateHandleController$OnRecreation.smali */
    static final class OnRecreation implements SavedStateRegistry.AutoRecreated {
        OnRecreation() {
        }

        @Override // androidx.savedstate.SavedStateRegistry.AutoRecreated
        public void onRecreated(SavedStateRegistryOwner owner) throws SecurityException {
    ...
    private static void tryToAddRecreator(final SavedStateRegistry registry, final Lifecycle lifecycle) throws SecurityException {
