...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali_classes3\kotlinx\coroutines\internal\LockFreeTaskQueue.smali */
public class LockFreeTaskQueue<E> {
    ...
    public final boolean addLast(E element) {
        ...
        while (true) {
            LockFreeTaskQueueCore cur = (LockFreeTaskQueueCore) this._cur$internal;
            int iAddLast = cur.addLast(element);
            if (iAddLast == 0) {
                return true;
            }
            if (iAddLast == 1) {
    ...
    public final E removeFirstOrNull() {
        Object obj;
        int i;
        LockFreeTaskQueue<E> lockFreeTaskQueue;
        int i2;
        Object obj2;
        int i3 = 0;
        LockFreeTaskQueue<E> lockFreeTaskQueue2 = this;
        int i4 = 0;
        while (true) {
            LockFreeTaskQueueCore lockFreeTaskQueueCore = (LockFreeTaskQueueCore) lockFreeTaskQueue2._cur$internal;
            while (true) {
                ...
                if ((LockFreeTaskQueueCore.FROZEN_MASK & j) == 0) {
                    ...
                    int i5 = (int) ((j & LockFreeTaskQueueCore.HEAD_MASK) >> 0);
                    i = i3;
                    if ((((int) ((j & LockFreeTaskQueueCore.TAIL_MASK) >> 30)) & lockFreeTaskQueueCore.mask) != (i5 & lockFreeTaskQueueCore.mask)) {
                        obj2 = lockFreeTaskQueueCore.array$internal.get(lockFreeTaskQueueCore.mask & i5);
                        if (obj2 == null) {
                            if (lockFreeTaskQueueCore.singleConsumer) {
                                lockFreeTaskQueue = lockFreeTaskQueue2;
                                i2 = i4;
                                obj = null;
                                break;
                            }
                            ...
                            i2 = i4;
                            i3 = i;
                            lockFreeTaskQueue2 = lockFreeTaskQueue;
                            i4 = i2;
                        } else if (!(obj2 instanceof LockFreeTaskQueueCore.Placeholder)) {
                            int i6 = (i5 + 1) & LockFreeTaskQueueCore.MAX_CAPACITY_MASK;
                            lockFreeTaskQueue = lockFreeTaskQueue2;
                            i2 = i4;
                            if (!LockFreeTaskQueueCore._state$FU$internal.compareAndSet(lockFreeTaskQueueCore, j, LockFreeTaskQueueCore.INSTANCE.updateHead(j, i6))) {
                                if (!lockFreeTaskQueueCore.singleConsumer) {
                                    i3 = i;
                                    lockFreeTaskQueue2 = lockFreeTaskQueue;
                                    i4 = i2;
                                    ...
                                    while (true) {
                                        LockFreeTaskQueueCore lockFreeTaskQueueCoreRemoveSlowPath = lockFreeTaskQueueCore2.removeSlowPath(i5, i6);
                                        if (lockFreeTaskQueueCoreRemoveSlowPath == null) {
                                            break;
                                        }
                                        lockFreeTaskQueueCore2 = lockFreeTaskQueueCoreRemoveSlowPath;
                                    }
                                }
                            } else {
                                lockFreeTaskQueueCore.array$internal.set(lockFreeTaskQueueCore.mask & i5, null);
                                break;
                            }
                        } else {
                            lockFreeTaskQueue = lockFreeTaskQueue2;
                        ...
                        if (obj2 == null) {
                            ...
                            if (!LockFreeTaskQueueCore._state$FU$internal.compareAndSet(lockFreeTaskQueueCore, j, LockFreeTaskQueueCore.INSTANCE.updateHead(j, i4))) {
                                if (!lockFreeTaskQueueCore.singleConsumer) {
                                    ...
                                    LockFreeTaskQueueCore lockFreeTaskQueueCore2 = lockFreeTaskQueueCore;
                                    while (true) {
                                        LockFreeTaskQueueCore lockFreeTaskQueueCoreRemoveSlowPath = lockFreeTaskQueueCore2.removeSlowPath(i3, i4);
                                        if (lockFreeTaskQueueCoreRemoveSlowPath == null) {
                                            break;
                                        }
                                        lockFreeTaskQueueCore2 = lockFreeTaskQueueCoreRemoveSlowPath;
