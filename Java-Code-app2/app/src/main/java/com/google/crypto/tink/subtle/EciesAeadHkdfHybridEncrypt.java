...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\com\google\crypto\tink\subtle\EciesAeadHkdfHybridEncrypt.smali */
public final class EciesAeadHkdfHybridEncrypt implements HybridEncrypt {
    ...
    public byte[] encrypt(final byte[] plaintext, final byte[] contextInfo) throws GeneralSecurityException {
        ...
        Aead aead = this.demHelper.getAead(kemKey.getSymmetricKey());
