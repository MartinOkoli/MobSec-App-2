...
/* loaded from: C:\Users\MaOk\Desktop\ADB\platform-tools-latest-windows\platform-tools\app-source3\base\smali\androidx\appcompat\app\TwilightCalculator.smali */
class TwilightCalculator {
    ...
    public void calculateTwilight(long time, double latitude, double longitude) {
        ...
        if (cosHourAngle >= 1.0d) {
            ...
            long jRound = Math.round((solarTransitJ2000 - hourAngle) * 8.64E7d) + UTC_2000;
            this.sunrise = jRound;
