...
public final class FragmentNavigatorExtrasKt {
    public static final FragmentNavigator.Extras FragmentNavigatorExtras(Pair<? extends View, String>... sharedElements) {
        ...
        FragmentNavigator.Extras.Builder $this$apply = new FragmentNavigator.Extras.Builder();
        for (Pair<? extends View, String> pair : sharedElements) {
            View view = pair.component1();
            String name = pair.component2();
            $this$apply.addSharedElement(view, name);
        }
        FragmentNavigator.Extras extrasBuild = $this$apply.build();
